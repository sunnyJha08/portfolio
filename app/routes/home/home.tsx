  ...
  return (
    <>
      ...
      <div className="">
        ...
        <section className="intro mt-6 flex gap-4">
          <Link
            to={
        ...
        <div className="mt-8 flex items-center gap-2">
          ...
          <span>
            <a
              href="https://www.instagram.com/sunnyjha98971/"
              aria-label="My insta link"
              target="_blank"
            >
              <svg
          ...
          <span>
            <a
              href="https://github.com/sunnyJha08/"
          ...
          <span>
            <a
              href="https://www.linkedin.com/in/sunnyjha08/"
