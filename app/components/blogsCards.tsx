...
export const BlogCard: React.FC<BlogProps> = ({ card }) => {
  return (
    <div className="flex h-full flex-col gap-2 overflow-hidden rounded-lg border border-gray-200 bg-white p-4 shadow-lg transition duration-300 hover:shadow-xl">
      <img
        src={card.imageUrl}
        alt={card.title}
        className="h-48 w-full rounded-sm object-cover"
      />
      <TypographyMuted value={card.date} /> <TypographyH4 value={card.title} />
...
export const BlogsCards: React.FC = () => {
  return (
    <div className="p-4">
